...
import com.jhipsterpress2.web.repository.BlogRepository;
import com.jhipsterpress2.web.service.BlogService;
import com.jhipsterpress2.web.service.dto.BlogDTO;
import com.jhipsterpress2.web.service.mapper.BlogMapper;
import com.jhipsterpress2.web.web.rest.errors.ExceptionTranslator;
import com.jhipsterpress2.web.service.dto.BlogCriteria;
import com.jhipsterpress2.web.service.BlogQueryService;
...
public class BlogResourceIntTest {
    ...
    @Test
    @Transactional
    public void getAllBlogsByPartyIsEqualToSomething() throws Exception {
        // Initialize the database
        Party party = PartyResourceIntTest.createEntity(em);
        em.persist(party);
        em.flush();
        ...
        // Get all the blogList where party equals to partyId
        defaultBlogShouldBeFound("partyId.equals=" + partyId);

        // Get all the blogList where party equals to partyId + 1
        defaultBlogShouldNotBeFound("partyId.equals=" + (partyId + 1));
    }
