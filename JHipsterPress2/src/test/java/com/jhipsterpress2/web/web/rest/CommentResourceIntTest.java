...
import com.jhipsterpress2.web.repository.CommentRepository;
import com.jhipsterpress2.web.service.CommentService;
import com.jhipsterpress2.web.service.dto.CommentDTO;
import com.jhipsterpress2.web.service.mapper.CommentMapper;
import com.jhipsterpress2.web.web.rest.errors.ExceptionTranslator;
import com.jhipsterpress2.web.service.dto.CommentCriteria;
import com.jhipsterpress2.web.service.CommentQueryService;
...
public class CommentResourceIntTest {
    ...
    @Test
    @Transactional
    public void getAllCommentsByPartyIsEqualToSomething() throws Exception {
        // Initialize the database
        Party party = PartyResourceIntTest.createEntity(em);
        em.persist(party);
        em.flush();
        ...
        // Get all the commentList where party equals to partyId
        defaultCommentShouldBeFound("partyId.equals=" + partyId);

        // Get all the commentList where party equals to partyId + 1
        defaultCommentShouldNotBeFound("partyId.equals=" + (partyId + 1));
    }
