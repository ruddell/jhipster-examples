...
import com.jhipsterpress2.web.service.AlbumService;
...
import com.jhipsterpress2.web.service.AlbumQueryService;
...
public class AlbumResourceIntTest {
    ...
    @Test
    @Transactional
    public void getAllAlbumsByPartyIsEqualToSomething() throws Exception {
        // Initialize the database
        ...
        // Get all the albumList where party equals to partyId
        defaultAlbumShouldBeFound("partyId.equals=" + partyId);

        // Get all the albumList where party equals to partyId + 1
        defaultAlbumShouldNotBeFound("partyId.equals=" + (partyId + 1));
    }
