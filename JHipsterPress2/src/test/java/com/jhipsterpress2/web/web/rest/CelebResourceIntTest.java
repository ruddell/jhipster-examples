...
import com.jhipsterpress2.web.repository.CelebRepository;
import com.jhipsterpress2.web.service.CelebService;
import com.jhipsterpress2.web.service.dto.CelebDTO;
import com.jhipsterpress2.web.service.mapper.CelebMapper;
...
public class CelebResourceIntTest {
    ...
    @Test
    @Transactional
    public void getAllCelebsByPartyIsEqualToSomething() throws Exception {
        // Initialize the database
        Party party = PartyResourceIntTest.createEntity(em);
        em.persist(party);
        em.flush();
        celeb.addParty(party);
        celebRepository.saveAndFlush(celeb);
        Long partyId = party.getId();

        // Get all the celebList where party equals to partyId
        defaultCelebShouldBeFound("partyId.equals=" + partyId);

        // Get all the celebList where party equals to partyId + 1
        defaultCelebShouldNotBeFound("partyId.equals=" + (partyId + 1));
    }
