    ...
    describe('Urllink Service', () => {
        ...
        describe('Service methods', () => {
            ...
            it('should create a Urllink', () => {
                service.create(new Urllink(null)).subscribe(received => {
            ...
            it('should update a Urllink', () => {
                service.update(new Urllink(123)).subscribe(received => {
