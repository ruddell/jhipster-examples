    ...
    describe('Frontpageconfig Service', () => {
        ...
        describe('Service methods', () => {
            ...
            it('should create a Frontpageconfig', () => {
                service.create(new Frontpageconfig(null)).subscribe(received => {
            ...
            it('should update a Frontpageconfig', () => {
                service.update(new Frontpageconfig(123)).subscribe(received => {
            ...
            it('should return a Frontpageconfig', () => {
            ...
            it('should return a list of Frontpageconfig', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new Frontpageconfig(123)]);
            });
