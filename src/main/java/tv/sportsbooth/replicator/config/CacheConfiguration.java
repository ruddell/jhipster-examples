package tv.sportsbooth.replicator.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, tv.sportsbooth.replicator.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, tv.sportsbooth.replicator.repository.UserRepository.USERS_BY_EMAIL_CACHE);
