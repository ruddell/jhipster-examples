package com.corsfix.test.config;
...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "oldtest@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "oldtest API";

        private String description = "oldtest API documentation";
