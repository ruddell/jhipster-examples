...
public class FooResource {
     ...
     */
    @GetMapping("/foos")
    public ResponseEntity<List<FooDTO>> getAllFoos(FooCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
