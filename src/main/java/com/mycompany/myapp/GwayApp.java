...
@EnableZuulProxy
public class GwayApp {

    private static final Logger log = LoggerFactory.getLogger(GwayApp.class);

    private final Environment env;

    public GwayApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(GwayApp.class);
