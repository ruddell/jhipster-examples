...
export class FooComponent implements OnInit, OnDestroy {
  ...
  registerChangeInFoos(): void {
    this.eventSubscriber = this.eventManager.subscribe('fooListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IFoo[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
