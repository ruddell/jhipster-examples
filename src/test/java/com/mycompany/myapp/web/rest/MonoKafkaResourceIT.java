...
public class MonoKafkaResourceIT {
    ...
    @Autowired
    private MonoKafkaProducer producer;

    @Autowired
    private MonoKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        MonoKafkaResource kafkaResource = new MonoKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/mono-kafka/publish?message=test"))
